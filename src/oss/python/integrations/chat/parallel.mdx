...
For detailed documentation of all features and configuration options, head to the @[`ChatParallelWeb`] API reference or or the [Parallel chat API quickstart](https://docs.parallel.ai/chat-api/chat-quickstart).
