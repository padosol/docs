...
| [Tool calling](/oss/langchain/tools) | [Structured output](/oss/langchain/structured-output#structured-output) | JSON mode | Image input | Audio input | Video input | [Token-level streaming](/oss/integrations/chat/litellm#async-and-streaming-functionality) | [Native async](/oss/integrations/chat/litellm#async-and-streaming-functionalityy) | [Token usage](/oss/langchain/models#token-usage) | [Logprobs](/oss/langchain/models#log-probabilities) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ | ❌ |
