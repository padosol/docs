...
Here are two examples of how to use the `TrubricsCallbackHandler` with LangChain [LLMs](/oss/langchain/models) or [Chat Models](/oss/langchain/models). We will use OpenAI models, so set your `OPENAI_API_KEY` key here:
