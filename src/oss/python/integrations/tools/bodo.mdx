...
The following examples are borrowed from [the Pandas DataFrames agent notebook](/oss/integrations/tools/pandas) with some modifications to highlight key differences.
